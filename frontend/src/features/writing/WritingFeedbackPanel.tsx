...
export default function WritingFeedbackPanel({ result }: WritingFeedbackPanelProps) {
  return (
    <div className="animate-rise flex flex-col gap-5">
      <div>
        <span className="text-xs font-semibold uppercase tracking-wide text-slate-400">Corrected text</span>
      ...
      <div>
        <span className="text-xs font-semibold uppercase tracking-wide text-slate-400">Feedback</span>
