  ...
  return (
    <div className="scroll min-h-0 flex-1 overflow-y-auto">
      <div className="mx-auto max-w-[880px] px-7 pb-20 pt-[30px]">
        <div className="mb-6">
          <div className="text-xs font-semibold uppercase tracking-wide text-indigo-500">Writing feedback</div>
        ...
        <div className="mb-6 rounded-2xl border border-indigo-100 bg-indigo-50 px-5 py-4 text-indigo-700">
          ...
          <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-5">
            <label className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-[14px] text-slate-900 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100"
              />
            </label>
            <label className="flex flex-1 flex-col gap-1.5">
              ...
              <textarea
                ...
                rows={9}
                placeholder="写下你的句子……"
                className="font-zh scroll min-h-[200px] flex-1 resize-none rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-[16px] text-slate-900 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100"
              />
            </label>
            <button
              type="button"
